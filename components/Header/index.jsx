...
export const Header = () => {
  ...
  return (
    <div className="flex flex-col-reverse space-y-reverse space-y-4 lg:space-y-0 lg:flex-row w-full px-2 lg:px-16 py-10 lg:pt-28 lg:pb-16 mx-auto max-w-5xl 2xl:max-w-6xl">
